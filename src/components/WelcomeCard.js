...
const WelcomeCard = () => {
  ...
  return (
    <div className="bg-blue-50 p-6 border border-blue-100 rounded-lg shadow-md">
      ...
      <ul className="text-sm text-gray-700 list-disc list-inside mb-4 pl-4 text-left">
        ...
        <li>Choose the number of rows to fetch (or fetch all rows).</li>
        <li>Click <strong>Fetch Data</strong> to retrieve the data.</li>
        <li>View the fetched data in a collapsible JSON viewer.</li>
        <li>Export the data as JSON for further use.</li>
      </ul>
      <h3 className="text-md font-semibold mb-2 flex items-center">
      ...
      <p className="text-sm text-gray-700 mb-4 text-left">
        This tool uses the <strong>Coda API</strong> to fetch data from your Coda document. It retrieves tables, rows, and columns based on your selections and displays them in an easy-to-read JSON format. You can export the data for further analysis or integration with other tools.
      </p>
      <h3 className="text-md font-semibold mb-2 flex items-center">
